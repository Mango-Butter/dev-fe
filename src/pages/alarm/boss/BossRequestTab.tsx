...
import useStaffStore from "../../../stores/useStaffStoreStore.ts";
import {
...
import BossScheduleRequestCard from "./BossScheduleRequestCard.tsx";
import BossAttendanceRequestCard from "./BossAttendanceRequestCard.tsx";

const BossRequestTab = () => {
  const { selectedStore } = useStaffStore();
