// src/pages/alarm/components/BossAttendanceRequestCard.tsx
...
const BossAttendanceRequestCard = ({ data, storeId, refetch }: Props) => {
...
export default BossAttendanceRequestCard;
