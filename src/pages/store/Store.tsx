    ...
    <div className="flex flex-1 self-stretch p-5 flex-col items-center justify-start h-full gap-6">
      <div className="flex p-4 border border-grayscale-300 bg-white shadow-blue-shadow rounded-xl flex-col justify-center items-start gap-2 self-stretch">
        ...
        <div className="flex w-full gap-2">
          <span className="w-fit body-2 text-grayscale-900">주소</span>
          <span className="body-2 text-grayscale-600">
            {activeStore.address}
          </span>
        </div>
        <div className="flex w-full gap-2">
          <span className="w-fit body-2 text-grayscale-900">초대코드</span>
          <span className="body-2 text-grayscale-600">
      ...
      <div className="flex flex-col items-start gap-3 self-stretch">
        ...
        >
          <span className="title-1">매장 정보</span>
          <span className="body-2 text-gray-500">
        ...
        <div
          ...
          className="cursor-pointer flex py-3 px-4 border border-grayscale-300 bg-white shadow-basic rounded-xl flex-col justify-center items-start gap-2 self-stretch"
        >
          <span className="title-1">출퇴근 방식 설정</span>
          <span className="body-2 text-gray-500">
            알바생이 출퇴근하는 방식을 설정해요
          </span>
        </div>
        ...
        <div
          onClick={() => navigate("/store/salary")}
          className="cursor-pointer flex py-3 px-4 border border-grayscale-300 bg-white shadow-basic rounded-xl flex-col justify-center items-start gap-2 self-stretch"
        >
          <span className="title-1">급여 설정</span>
          <span className="body-2 text-gray-500">
        ...
        <div
          onClick={() => navigate("/store/notification")}
          className="cursor-pointer flex py-3 px-4 border border-grayscale-300 bg-white shadow-basic rounded-xl flex-col justify-center items-start gap-2 self-stretch"
        >
          <span className="title-1">알림 설정</span>
          <span className="body-2 text-gray-500">
            매장에서의 알림 범위를 설정해요
          </span>
        </div>
