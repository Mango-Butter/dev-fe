  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {taskRoutineRepeatType === "WEEKLY" && (
        <section>
          <div className="flex items-center gap-1 mb-2">
            <label className="title-1 text-grayscale-900">반복 요일 선택</label>
            <span className="text-warning text-lg">*</span>
          </div>
          <Controller
            control={control}
      ...
      {taskRoutineRepeatType === "MONTHLY" && (
        <section>
          <div className="flex items-center gap-1 mb-2">
            <label className="title-1 text-grayscale-900">반복 날짜 선택</label>
            <span className="text-warning text-lg">*</span>
          </div>
          <Controller
            control={control}
      ...
      <section>
        ...
        {(errors.startTime || errors.endTime) && (
          <p className="text-xs text-warning mt-1">시간을 모두 입력해주세요.</p>
        )}
      </section>
